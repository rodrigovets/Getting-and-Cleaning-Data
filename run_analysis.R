# Store the UCI HAR Dataset folder in your main directory
# Rename the "UCI HAR Dataset" folder to "UCI_HAR_Dataset"
# Create and store this script at the main directory
...
write.table(cleanedData, "mergeddata.txt") # write txt file with the 1st data set
...
head(result)
write.table(result, "tidydataset.txt", row.name=FALSE) # write txt file with the 2nd data set without row names